	...
	initial_data_source?: {
		...
		properties?: Record<
			string,
			{
				...
				| { type?: "status"; status: EmptyObject }
				| {
						type?: "relation"
				...
				| { type?: "location"; location: EmptyObject }
				| { type?: "verification"; verification: EmptyObject }
				| { type?: "last_visited_time"; last_visited_time: EmptyObject }
				| { type?: "place"; place: EmptyObject }
			)
		>
	}
