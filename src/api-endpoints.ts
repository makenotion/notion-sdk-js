  ...
  filter?:
    | {
        ...
        filters: Array<
          | {
              ...
              filter: {
                ...
                operator:
                  ...
                  | "is_empty"
                  | "is_not_empty"
                // Text filter value for string_contains and similar operators.
                value?: {
                  type: "exact"
          ...
          | {
              // Meeting-note date property name.
              property: "created_time" | "last_edited_time"
              filter: {
                ...
                operator:
                  ...
                  | "is_empty"
                  | "is_not_empty"
                // Value for date filter operators.
                value?:
                  | {
                      type: "relative" | "exact"
                      value:
          ...
          | {
              // Meeting-note person property name.
              property: "created_by" | "last_edited_by" | "attendees"
              filter: {
                ...
                operator:
                  ...
                  | "is_empty"
                  | "is_not_empty"
                // Value for person filter operators.
                value?:
                  | {
                      type: "exact"
    ...
    | {
        ...
        filter: {
          ...
          // Value for person filter operators.
          value?:
            | { type: "exact"; value: { table: "notion_user"; id: string } }
            | Array<{
                type: "exact"
                value: { table: "notion_user"; id: string }
              }>
